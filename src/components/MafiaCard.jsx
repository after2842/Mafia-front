      ...
      <div className="relative flex flex-col h-full z-10">
        ...
        <div className="flex-1 flex items-center justify-center py-4">
          <div className="relative">
            <Skull className="w-24 h-24 text-black transition-transform duration-500 group-hover:scale-110 relative z-10" />
            <div className="absolute top-1 left-1 w-24 h-24 bg-red-600 border-2 border-black -z-10 rounded-lg group-hover:translate-x-2 group-hover:translate-y-2 transition-transform" />
          </div>
        </div>
